// g++ lib_files/Graph.cpp lib_files/Window.cpp lib_files/GUI.cpp lib_files/Simple_window.cpp ch136.cpp `fltk-config --ldflags --use-images` -o a.out
...
try {
    ...
    Point tl(200,50);
    Simple_window win(tl,1200,800,"Ch13 - 6.feladat");

    Textbox tb_win(Point(100,50),70,"Window");  //pont, szélesség, elnevezés
    ...
    Arrow a_ln(n(tb_ln),sw(tb_shp));    //honnan-hova mutat
    win.attach(a_ln);
